...
- [CASB & Network (SWG) integrations](/integrations/casb/overview) — connect the log sources.
- [Endpoint Agent](/agent/overview) — for endpoints you can manage directly.
