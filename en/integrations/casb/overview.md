...
The result is a live inventory of **which source IPs and users are calling which AI providers**, surfaced in [Network Sources](/en/discovery/network-sources).

## Supported connectors

| Connector | Data source | Status |
|-----------|-------------|--------|
| [Cisco Umbrella](/en/integrations/casb/cisco-umbrella) | DNS-layer Reporting API v2 | Available |
...
- [Network Sources](/en/discovery/network-sources) — the discovered inventory and triage workflow.
- [Endpoint Agent](/en/agent/overview) — for endpoints where you *can* deploy an agent.
