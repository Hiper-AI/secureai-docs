...
After the first sync, open [Network Sources](/discovery/network-sources) — sources that resolved AI domains appear with their provider(s), call counts, and severity.

## Related

- [CASB & Network Overview](/integrations/casb/overview)
- [Network Sources](/discovery/network-sources)
