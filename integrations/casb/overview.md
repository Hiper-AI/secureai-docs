...
The result is a live inventory of **which source IPs and users are calling which AI providers**, surfaced in [Network Sources](/discovery/network-sources).

## Supported connectors

| Connector | Data source | Status |
|-----------|-------------|--------|
| [Cisco Umbrella](/integrations/casb/cisco-umbrella) | DNS-layer Reporting API v2 | Available |
...
- [Network Sources](/discovery/network-sources) — the discovered inventory and triage workflow.
- [Endpoint Agent](/agent/overview) — for endpoints where you *can* deploy an agent.
