...
- **NHIs** — API keys, service accounts, and BYOK keys (revocable — see [NHI Inventory](/discovery/nhi-inventory))
- **Spend limits**
...
Open [Cloud Sensors](/discovery/cloud-sensors) for discovered workspaces/agents and [NHI Inventory](/discovery/nhi-inventory) for keys and service accounts. Insights show usage, cost, and spend limits.

## Revocation

Anthropic API keys, service accounts, and BYOK keys are **revocable** from [NHI Inventory](/discovery/nhi-inventory).
