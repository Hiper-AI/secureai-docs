...
- **NHIs** — API keys, service accounts, and BYOK keys (revocable — see [NHI Inventory](/zh/discovery/nhi-inventory))
- **Spend limits**
...
Open [Cloud Sensors](/zh/discovery/cloud-sensors) for discovered workspaces/agents and [NHI Inventory](/zh/discovery/nhi-inventory) for keys and service accounts. Insights show usage, cost, and spend limits.

## Revocation

Anthropic API keys, service accounts, and BYOK keys are **revocable** from [NHI Inventory](/zh/discovery/nhi-inventory).
