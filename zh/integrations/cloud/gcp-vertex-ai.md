...
- **NHIs** — service accounts, service-account keys, and API keys (revocable — see [NHI Inventory](/zh/discovery/nhi-inventory))
- **IAM** role bindings
- **Cloud Audit Logs**
...
Open [Cloud Sensors](/zh/discovery/cloud-sensors) for discovered agents/endpoints/models and [NHI Inventory](/zh/discovery/nhi-inventory) for service accounts and keys. Insights show IAM bindings, usage, and cost.

## Revocation

GCP service accounts, SA keys, and API keys are **revocable** from [NHI Inventory](/zh/discovery/nhi-inventory) when the connector has the optional key/SA admin roles.
