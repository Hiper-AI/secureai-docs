...
After the first sync, open [Network Sources](/zh/discovery/network-sources) — sources that resolved AI domains appear with their provider(s), call counts, and severity.

## Related

- [CASB & Network Overview](/zh/integrations/casb/overview)
- [Network Sources](/zh/discovery/network-sources)
