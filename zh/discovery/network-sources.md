...
- [CASB & Network (SWG) integrations](/zh/integrations/casb/overview) — connect the log sources.
- [Endpoint Agent](/zh/agent/overview) — for endpoints you can manage directly.
